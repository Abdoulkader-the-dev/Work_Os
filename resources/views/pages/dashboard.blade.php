...
<div style="display:flex;flex-direction:column;gap:24px;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:14px;">
        ...
        {{-- Time tracker --}}
        <div class="bento-card" style="display:flex;align-items:center;gap:16px;padding:14px 20px;cursor:pointer;"
             x-data="timeTracker()" @click="toggle()">
            <div>
                <div style="font-size:13px;font-weight:500;">Démarrer le chrono</div>
                <div style="font-size:18px;font-weight:600;font-family:'DM Mono',monospace;letter-spacing:-0.02em;margin-top:2px;color:var(--text-1);"
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px;">
        ...
        {{-- Activité hebdo --}}
        <div class="bento-card" style="padding:20px;cursor:pointer;" x-data>
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                <span style="font-size:13px;font-weight:500;color:var(--text-2);">Activité hebdo</span>
                <button style="width:24px;height:24px;display:flex;align-items:center;justify-content:center;border-radius:4px;border:none;background:none;color:var(--text-3);cursor:pointer;font-size:16px;line-height:1;"
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-end;">
                ...
                <div style="width:44px;height:44px;background:var(--yellow-light);border-radius:10px;display:flex;align-items:center;justify-content:center;transition:transform .2s;">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" style="color:var(--yellow);">
        ...
        <div class="bento-card" style="padding:20px;cursor:pointer;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                <span style="font-size:13px;font-weight:500;color:var(--text-2);">Temps travaillé</span>
                <button style="width:24px;height:24px;display:flex;align-items:center;justify-content:center;border-radius:4px;border:none;background:none;color:var(--text-3);cursor:pointer;font-size:16px;line-height:1;">···</button>
            </div>
            <div style="display:flex;justify-content:space-between;align-items:flex-end;">
                <div>
                    ...
                    <div style="font-size:11px;color:var(--text-3);font-family:'DM Mono',monospace;margin-top:6px;">cette semaine</div>
                </div>
                <div style="width:44px;height:44px;background:var(--yellow-light);border-radius:10px;display:flex;align-items:center;justify-content:center;">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" style="color:var(--yellow);">
        ...
        <div class="bento-card" style="padding:20px;cursor:pointer;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                <span style="font-size:13px;font-weight:500;color:var(--text-2);">Projets actifs</span>
                <button style="width:24px;height:24px;display:flex;align-items:center;justify-content:center;border-radius:4px;border:none;background:none;color:var(--text-3);cursor:pointer;font-size:16px;line-height:1;">···</button>
            </div>
            <div style="display:flex;justify-content:space-between;align-items:flex-end;">
                <div>
                    <div style="font-size:32px;font-weight:600;letter-spacing:-0.04em;line-height:1;">
                        {{ str_pad($activeBoards ?? 0, 2, '0', STR_PAD_LEFT) }}
                    </div>
                    <div style="font-size:11px;color:var(--text-3);font-family:'DM Mono',monospace;margin-top:6px;">en cours</div>
                </div>
                <div style="width:44px;height:44px;background:var(--yellow-light);border-radius:10px;display:flex;align-items:center;justify-content:center;">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" style="color:var(--yellow);">
            ...
            <div style="display:flex;flex-direction:column;gap:0;">
                ...
                @empty
                    ...
                    <div style="text-align:center;padding:32px 0;">
                        ...
                        <div style="font-size:13px;color:var(--text-3);">Aucune activité récente</div>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div class="bento-card" style="padding:20px;display:flex;flex-direction:column;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px;">
                ...
                <a href="{{ route('boards.index') }}"
                   style="font-size:12px;font-weight:500;color:var(--text-2);text-decoration:none;display:flex;align-items:center;gap:4px;padding:5px 10px;border-radius:6px;border:1px solid var(--border);transition:all .15s;"
            ...
            <div style="flex:1;display:flex;flex-direction:column;gap:2px;">
                @forelse($boards ?? [] as $board)
                    <a href="{{ route('boards.show', $board) }}"
                       style="display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:8px;text-decoration:none;color:inherit;transition:background .15s;cursor:pointer;"
                       onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''">
                        {{-- Dot couleur --}}
                        ...
                        <div style="width:80px;height:3px;background:var(--bg);border-radius:10px;flex-shrink:0;overflow:hidden;">
                            <div style="height:100%;background:var(--blue);border-radius:10px;width:{{ $board->progress ?? 0 }}%;transition:width .4s;"></div>
                        </div>
                        {{-- Count --}}
                        <span style="font-size:11px;font-family:'DM Mono',monospace;color:var(--text-3);flex-shrink:0;">
                            {{ $board->items_count ?? 0 }}
                        </span>
                    </a>
                @empty
            ...
            <a href="{{ route('boards.index') }}"
               style="display:block;margin-top:14px;padding:9px;background:var(--text-1);color:#fff;text-align:center;border-radius:8px;font-size:13px;font-weight:500;text-decoration:none;transition:background .15s;"
    ...
    <div class="bento-card" style="padding:20px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px;">
            ...
            <a href="{{ route('my-tasks') }}" style="font-size:12px;color:var(--blue);text-decoration:none;font-weight:500;">
                Voir tout →
            </a>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:10px;">
            @forelse($urgentTasks ?? [] as $task)
                <div style="display:flex;align-items:flex-start;gap:10px;padding:12px;background:var(--bg);border-radius:10px;cursor:pointer;transition:background .15s;"
                    ...
                    <div style="width:6px;height:6px;border-radius:50%;margin-top:5px;flex-shrink:0;
                        background:{{ $task->status === 'blocked' ? '#dc2626' : ($task->priority === 'critique' ? '#8b5cf6' : '#f97316') }};">
                    </div>
                    <div style="flex:1;min-width:0;">
                        ...
                        <div style="font-size:11px;color:var(--text-3);font-family:'DM Mono',monospace;margin-top:3px;">
                            {{ $task->board->name ?? '' }} · {{ $task->deadline?->format('d M') ?? 'Sans deadline' }}
                        </div>
                    </div>
    ...
    <div class="bento-card" style="padding:20px;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px;">
            ...
            <a href="{{ route('members') }}" style="font-size:12px;color:var(--blue);text-decoration:none;font-weight:500;">
                Gérer →
            </a>
        </div>
            ...
            <table style="width:100%;border-collapse:collapse;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:left;font-size:11px;font-weight:500;color:var(--text-3);letter-spacing:.05em;text-transform:uppercase;padding:0 10px 10px;">Tâche en cours</th>
                        <th style="text-align:center;font-size:11px;font-weight:500;color:var(--text-3);letter-spacing:.05em;text-transform:uppercase;padding:0 10px 10px;">Aujourd'hui</th>
                        <th style="text-align:center;font-size:11px;font-weight:500;color:var(--text-3);letter-spacing:.05em;text-transform:uppercase;padding:0 0 10px;">Cette semaine</th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <td style="padding:10px 10px 10px 0;border-top:1px solid var(--border);">
                                <div style="display:flex;align-items:center;gap:10px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size:11px;color:var(--text-3);">{{ $member->role ?? 'Membre' }}</div>
                                    </div>
                                </div>
                            </td>
                            <td style="padding:10px;border-top:1px solid var(--border);font-size:13px;color:var(--text-2);">
                                {{ $member->currentTask?->name ?? '—' }}
                            </td>
                            <td style="padding:10px;border-top:1px solid var(--border);text-align:center;font-size:12px;font-family:'DM Mono',monospace;color:var(--text-2);">
                                {{ $member->todayHours ?? '00:00' }}
                            </td>
                            <td style="padding:10px 0 10px 10px;border-top:1px solid var(--border);text-align:center;font-size:12px;font-family:'DM Mono',monospace;color:var(--text-2);">
                                {{ $member->weekHours ?? '00:00' }}
                            </td>
                        </tr>
                    @empty
                        <tr>
