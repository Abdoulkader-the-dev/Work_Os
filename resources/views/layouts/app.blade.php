...
<body x-data="appShell()" @keydown.escape.window="closeMobileSidebar()">
    ...
    <aside id="sidebar" :class="{ 'open': mobileSidebarOpen }">
        ...
        <div style="padding:12px; border-top:1px solid var(--border);">
            ...
            {{-- Dropdown workspaces — x-cloak empêche l'affichage avant Alpine ── --}}
    ...
    <div style="flex:1;display:flex;flex-direction:column;overflow:hidden;min-width:0;">
        ...
        <header id="topbar">
            ...
            <button class="icon-btn" style="display:none;" id="burger-btn"
                    @click="toggleMobileSidebar()" aria-label="Menu">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
...
<div x-data="{ open: false }" style="position:relative;">
    ...
    <div x-show="open"
         ...
         style="position:absolute;right:0;top:calc(100% + 8px);width:200px;background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-card);box-shadow:0 12px 32px rgba(0,0,0,0.1);padding:6px;z-index:60;transform-origin:top right;">
