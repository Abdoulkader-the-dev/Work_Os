...
<div style="max-width:820px;margin:0 auto;display:flex;flex-direction:column;gap:32px;">
    ...
    <div class="flex-between" style="padding-top:20px;border-top:1px solid var(--border);padding-bottom:40px;">
        ...
        <div class="flex-center" style="gap:10px;">
            @if($meetingId)
                <a href="{{ route('meetings.pdf', $meetingId) }}" target="_blank" class="view-btn text-sm font-medium" style="padding:9px 18px;height:auto;border:1px solid var(--border);text-decoration:none;color:inherit;display:inline-flex;align-items:center;justify-content:center;">
                    Aperçu PDF
                </a>
            @else
                <button disabled class="view-btn text-sm font-medium" style="padding:9px 18px;height:auto;border:1px solid var(--border);opacity:0.5;cursor:not-allowed;" title="Veuillez d'abord enregistrer le compte rendu">
                    Aperçu PDF
                </button>
            @endif
